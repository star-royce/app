 ...
 */
layui.define(["i18n", "element", "layer", "jquery"], function (exports) {
        ...
        listen: function (options) {
            ...
            $('body').on('click', '[layuimini-href]', function () {
                ...
                try {
                    ...
                    $("#multi_module_bottom").attr("class", "layui-nav layui-nav-tree layui-left-nav-tree");
                    $("#multi_module_top").attr("class", "layui-nav layui-nav-tree layui-left-nav-tree");

                } catch (e) { }

                try {
                    if (href.includes("ImportCommodity.html")) {
                        $("#bindShopify").show();
                        $("#addProduct").hide();
                    } else {
                        $("#bindShopify").hide();
